...
[![Web App](https://img.shields.io/badge/Web_App-Online-blue?logo=next.js)](https://jaywcjlove.github.io/awesome-mac)
...
This project is now available as an interactive web application with search, filtering, and more:

[**Visit Awesome Mac Web App**](https://jaywcjlove.github.io/awesome-mac)

Features include:

- Full-text search across all apps
- Filter by free, open-source, and App Store apps
- Browse by category
- Individual app pages with details
...
- [Contributing Code](CONTRIBUTING_CODE.md) - Code contribution guide
